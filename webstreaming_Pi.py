...
outputFrame = None
lock = threading.Lock()
engine = DetectionEngine('/home/pi/Flask-Coral-Edge-TPU/tpu/mobilenet_ssd_v2_coco_quant_postprocess_edgetpu.tflite')
labels = dataset_utils.read_label_file('/home/pi/Flask-Coral-Edge-TPU/tpu/coco_labels.txt')
...
def detect_objects():
    ...
    while True:
        ...
        with lock:
            outputFrame = cv2.resize(frame, (416, 416))
